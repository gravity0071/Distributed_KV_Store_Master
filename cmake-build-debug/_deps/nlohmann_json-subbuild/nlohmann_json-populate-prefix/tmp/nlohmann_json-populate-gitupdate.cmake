...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.10.5"
  WORKING_DIRECTORY "/Users/wukangxin/Desktop/Distributed_KV_Store_Master/cmake-build-debug/_deps/nlohmann_json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/wukangxin/Desktop/Distributed_KV_Store_Master/cmake-build-debug/_deps/nlohmann_json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/wukangxin/Desktop/Distributed_KV_Store_Master/cmake-build-debug/_deps/nlohmann_json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
